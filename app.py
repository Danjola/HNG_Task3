...
def send_email(recipient):
    ...
    try:
        ...
        port = 587
        username = 'danjola2012@gmail.com'
        password = os.getenv('MAILTRAP_API_TOKEN', 'tgyd ehlz gcyr tabg')

        msg = MIMEMultipart('alternative')
        msg['Subject'] = "Task3_ HNG_mail!"
        msg['From'] = "Apotieri Oluwa <danjola2012@gmail.com>"
        msg['To'] = recipient
